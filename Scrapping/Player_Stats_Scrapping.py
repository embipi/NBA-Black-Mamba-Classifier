...
## Get nba team url and accept conditions to continue
try:
    browser.get(url)
    sleep(5)
...
for team in urls.url:
    ...
    url = 'https://www.nba.com/stats/team/'+str(team)+'/'
    ...
    try:
        browser.get(url+"players-traditional/")
        sleep(5)
    except:
        sleep(5)
        browser.get(url+"players-traditional/?Season=2021-22&SeasonType=Regular%20Season")
        sleep(5)
    ...
    ## Get Advanced stats
    try:
        browser.get(url+"players-advanced/")
        sleep(5)
    except:
        sleep(5)
        browser.get(url+"players-advanced/?Season=2021-22&SeasonType=Regular%20Season")
        sleep(5)
    ...
    ## Get misc stats
    try:
        browser.get(url+"players-misc/")
        sleep(5)
    except:
        sleep(5)
        browser.get(url+"players-misc/?Season=2021-22&SeasonType=Regular%20Season")
        sleep(5)
    ...
    ## Get Scoring stats
    try:
        browser.get(url+"players-scoring/")
        sleep(5)
    except:
        sleep(5)
        browser.get(url+"players-scoring/?Season=2021-22&SeasonType=Regular%20Season")
        sleep(5)
    ...
    ## Get Usage stats
    try:
        browser.get(url+"players-usage/")
        sleep(5)
    except:
        sleep(5)
        browser.get(url+"players-usage/?Season=2021-22&SeasonType=Regular%20Season")
        sleep(5)
